$(document).ready(function () {
    ...
    if ($('#stock_report_date_range').length == 1) {
            ...
            $('#stock_report_date_range').daterangepicker( {...dateRangeSettings,startDate: startOfYear,endDate: endOfYear}, function(start, end) {
    ...
    if ($('#stock_summary_date_range').length == 1) {
            let startOfYear = moment().startOf('year');
            let endOfYear = moment().endOf('year');
        $('#stock_summary_date_range').daterangepicker( {...dateRangeSettings,startDate: startOfYear,endDate: endOfYear}, function (start, end) {
        ...
        $('#stock_summary_date_range').data('daterangepicker').setEndDate(moment().endOf('year'));
    }
