    ...
    <div class="row">
       ...
       <div class="col-sm-4">
        <div class="form-group">
            ...
            <br>
              <label>
                {!! Form::checkbox('pos_settings[hide_purchase_price]', 1,  
                    !empty($pos_settings['hide_purchase_price']) ? true : false , 
                [ 'class' => 'input-icheck']); !!} {{ __( 'business.hide_purchase_price' ) }} 
              </label>
              @if(!empty($help_explanations['hide_purchase_price'])) 
                  @show_tooltip($help_explanations['hide_purchase_price']) 
              @endif
            </div>
        </div>
    </div>
