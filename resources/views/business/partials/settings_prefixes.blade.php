<div class="pos-tab-content">
     <div class="row">
        <div class="col-sm-12">
            <div class="row">
                <div class="col-sm-12"><h3>Supplier & Customer Prefix</h3></div>
                <div class="col-sm-4">
                    <div class="form-group">
                        @php
                            $supplier_add_purchase_prefix = '';
                        ...
                        {!! Form::text('ref_no_prefixes[supplier_add_purchase]', $supplier_add_purchase_prefix, ['class' => 'form-control']); !!}
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('ref_no_prefixes[supplier_list_purchase]', $supplier_list_purchase, ['class' => 'form-control']); !!}
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
                                @lang('lang_v1.starting_number')
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('ref_no_prefixes[customer_payment]', $customer_payment_prefix, ['class' => 'form-control']); !!}
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
                                @lang('lang_v1.starting_number')
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('ref_no_prefixes[customer_bulk_payment]', $customer_bulk_payment, ['class' => 'form-control']); !!}
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
                                @lang('lang_v1.starting_number')
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        @php
                            $customer_list_statement_prefix = '';
                        ...
                        {!! Form::text('ref_no_prefixes[customer_list_statement]', $customer_list_statement_prefix, ['class' => 'form-control']); !!}
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
                                @lang('lang_v1.starting_number')
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('ref_no_prefixes[customer_vat_statement]', $customer_vat_statement_prefix, ['class' => 'form-control']); !!}
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
                                @lang('lang_v1.starting_number')
        ...
        <div class="col-sm-12"><h3>Others Prefix</h3></div> 
        <div class="col-sm-4">
            <div class="form-group">
                @php
                    $purchase_prefix = '';
