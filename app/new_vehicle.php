...
class new_vehicle extends Model
{
     ...
     */
     ...
     public static function vehicleDetails($business_id)
     {
         $vehicle = new_vehicle::where('business_id', $business_id)->get();
         return $vehicle;
     }
     public static function forDropdown($show_all = false, $receipt_printer_type_attribute = false, $append_id = true)
    {
        ...
        $result =new_vehicle::where('business_id', $business_id)->get();
