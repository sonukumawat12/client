        ...
        <div class="col-md-12">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-2">
                    ...
                    ['class' => 'form-control', 'id' => 'F14_form_sn','readonly']) !!}
                </div>
                <div class="col-md-2">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-2">
                    ...
                    ['class' => 'form-control', 'id' => 'F17_form_sn','readonly']) !!}
                </div>
                <div class="col-md-2">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-2">
                    ...
                    ['class' => 'form-control', 'id' => 'F20_form_sn','readonly']) !!}
                </div>
                <div class="col-md-2">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-2">
                    ...
                    ['class' => 'form-control', 'id' => 'F21_form_sn','readonly']) !!}
                </div>
                <div class="col-md-2">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-2">
                    ...
                    ['class' => 'form-control', 'id' => 'F22_form_sn','readonly']) !!}
                </div>
                <div class="col-md-2">
