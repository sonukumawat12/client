            ...
            @component('components.filters', ['title' => __('report.filters')])
                <div class="col-md-3" id="location_filter">
                    <div class="form-group">
                        ...
                        {!! Form::select('20_location_id', $business_locations, null, [
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('F20_from_no', $F20_form_sn, ['class' => 'form-control', 'readonly', 'id' => 'F20_form_sn']) !!}
                    </div>
                </div>
            @endcomponent
        </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4 text-red" style="margin-top: 14px;">
                            <b>@lang('petro::lang.date_range'): <span class="from_date"></span> @lang('petro::lang.to') <span
                                    class="to_date"></span> </b>
                        </div>
                        <div class="col-md-5">
                            <div class="text-center">
                                <h5 style="font-weight: bold;">{{ request()->session()->get('business.name') }} <br>
                                    <span class="f20_location_name">@lang('petro::lang.all')</span>
                                </h5>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center pull-left">
                                <h5 style="font-weight: bold;" class="text-red">@lang('mpcs::lang.f20_form') @lang('mpcs::lang.form_no') : <span
                                        id="form_no1">{{ $F20_form_sn }}</span></h5>
                            </div>
                        </div>
                    </div>
