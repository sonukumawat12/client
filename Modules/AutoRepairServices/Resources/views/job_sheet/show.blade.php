...
<section class="content">
    ...
    <div style="display: flex; width: 1000px; padding-top: 40px;">
        <!-- Logo Section -->
        <div style="width: 30%;">
            @if(!empty(Session::get('business.logo')))
                <img src="{{ asset('uploads/business_logos/' . Session::get('business.logo')) }}" alt="Logo" style="width: auto; max-height: 90px;">
            @endif
        </div>
        ...
        <div style="width: 30%; text-align: center;">
            <p style="padding-left: 40px;">
                ...
                @endif
                <span>{!! $job_sheet->businessLocation->location_address !!}</span>
                @if(!empty($job_sheet->businessLocation->mobile))
                    <br>@lang('business.mobile'): {{ $job_sheet->businessLocation->mobile }},
                @endif
                ...
                @if(!empty($job_sheet->businessLocation->email))
                    <br>@lang('business.email'): {{ $job_sheet->businessLocation->email }},
                @endif
    ...
    <td colspan="2">
        <div style="display: flex; align-items: center; gap: 10px;">
            <b>@lang('repair::lang.customer_signature'):</b>
             <hr style="width: 30%; height: 1px; border: none; background: repeating-linear-gradient(90deg, black 0, black 5px, transparent 5px, transparent 10px);">
        </div>
    </td>
    <td>
        <div style="display: flex; align-items: center; gap: 10px;">
