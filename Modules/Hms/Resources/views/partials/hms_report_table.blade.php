    ...
    <tbody>
        @foreach ($all_room_types as $index => $all_room_type)
            <tr>
                ...
                <td class="display_currency" data-currency_symbol="true">{{ number_format($all_room_type->total_price, $currency_precision) }}</td>
                ...
                @if (isset($confirmed_room_types[$index]))
                    <td class="display_currency" data-currency_symbol="true">
                        {{ number_format($confirmed_room_types[$index]->total_price, $currency_precision) }}
                    </td>
                @endif
                ...
                @if (isset($cancelled_room_types[$index]))
                    <td class="display_currency" data-currency_symbol="true">
                        {{ number_format($cancelled_room_types[$index]->total_price, $currency_precision) }}
                    </td>
                @endif
                ...
                @if (isset($pending_room_types[$index]))
                    <td class="display_currency" data-currency_symbol="true">
                        {{ number_format($pending_room_types[$index]->total_price, $currency_precision) }}
                    </td>
                @endif
            </tr>
        @endforeach
