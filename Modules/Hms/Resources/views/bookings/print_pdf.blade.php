...
<div class="width-100 box mb-10" style="margin-bottom: 10px;">
...
<div class="box mb-10" style="margin-bottom: 10px;">
    ...
    <table class="no-border table-pdf">
        <thead>
            <tr style="background-color: #337ab7;">
                <th style="color: white;">@lang('hms::lang.rooms')</th>
            </tr>
        </thead>
...
<div class="width-100 box mb-10" style="margin-bottom: 10px;">
    <table class="no-border table-pdf">
        <thead>
            <tr style="background-color: #337ab7;">
                <th style="color: white;">@lang('hms::lang.extras')</th>
            </tr>
        </thead>
