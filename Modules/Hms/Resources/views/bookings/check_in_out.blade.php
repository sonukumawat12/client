                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <strong>@lang('hms::lang.discount'):</strong> ( {{ number_format($transaction->discount_amount, $currency_precision)  }} % )
                                </div>
                                <div class="col-xs-6 text-right">
                                    ...
                                    <div class="col-xs-6 text-right">
                                        <strong class="total_discount"> <span class="display_currency" data-currency_symbol="true"> {{number_format($transaction->discount_amount, $currency_precision)}} </span></strong>
                                        @endif
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 text-right">
                                        <strong class="total"> <span class="display_currency" data-currency_symbol="true"> {{number_format($transaction->final_total, $currency_precision)}}</span></strong>
                                    </div>
                                    <div class="col-xs-6">
                                        <strong>@lang('hms::lang.total_paid'):</strong>
                                    </div>
                                    <div class="col-xs-6 text-right">
                                        <strong class="total"> <span class="display_currency" data-currency_symbol="true">{{number_format($transaction->total_paid, $currency_precision)}} </span></strong>
                                    </div>
                                    <div class="col-xs-6">
                                        <strong>@lang('hms::lang.due'):</strong>
                                    </div>
                                    <div class="col-xs-6 text-right">
                                        <strong class="total"> <span class="display_currency" data-currency_symbol="true"> {{number_format($transaction->final_total - $transaction->total_paid, $currency_precision)}} </span></strong>
                                    </div>
                                </div>
                            </div>
                        </div>
