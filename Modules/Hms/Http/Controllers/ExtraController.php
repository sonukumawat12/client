...
class ExtraController extends Controller
{
   ...
   $html = '<a type="button" class="btn btn-primary  btn-xs" id="edit_extra"  data-href="' . action([\Modules\Hms\Http\Controllers\ExtraController::class, 'edit'], ['extra' => $row->id]) . '">
                         <i class="fa fa-edit"></i>  ' . __('messages.edit') . '</a>';
                    $html .= ' <a type="button" class="btn btn-danger btn-xs delete_room_confirmation" href="' . action([\Modules\Hms\Http\Controllers\ExtraController::class, 'destroy'], [$row->id]) . '">
